          ...
          <TableRow key={doc.id}>
            ...
            <TableCell>
              <div className="flex flex-wrap gap-1">
                ...
                {doc.doc_type && <Badge variant="outline">{doc.doc_type}</Badge>}
                {doc.equipment_model && <Badge variant="outline">{doc.equipment_model}</Badge>}
                {doc.metadata_confirmed && <Badge variant="secondary">confirmed</Badge>}
              </div>
            </TableCell>
              ...
              {doc.processing_tasks.length > 0 && (() => {
                ...
                return (
                  <div className="min-w-[180px] space-y-2">
                    ...
                    {task.error_message && (
                      <p className="line-clamp-2 text-xs text-destructive">{task.error_message}</p>
                    )}
                  </div>
                );
              })()}
